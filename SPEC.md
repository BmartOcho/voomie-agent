...
10. **Persist and notify.** Final job record contains: customer reference, declaration source, structured action plan, attachment metadata, conversation log, out-of-scope notes, due date, rush flag, and any human-review flags. Status transitions to ready for review or clarification needed; dashboard surfaces it.
